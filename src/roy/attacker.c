...
// #define PRIME_EVERY 250 <<<-------------------------------- 100 is better
#define PRIME_EVERY 100

#define BURST_WINDOW 15
...
int main(int argc, char **argv)
{
    ...
    while (detected_count < MAX_DETECTIONS)
    {
        ...
        if (fr_res[0] < 100)
        {
            ...
            // curr_head = prime(curr_head);------------------------------------------------moved out of here
            // now do the burst window
        ...
        // dont forget the maintnace prime to keep all close let's say every 100 iterations
